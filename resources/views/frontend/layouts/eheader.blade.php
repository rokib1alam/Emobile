                	...
                	<div class="d-flex align-items-center justify-content-center justify-content-md-end">
                        ...
                        <div class="ms-3">
                            <select name="countries" class="custome_select">
                                ...
                                <option value='{{$settings->currency}}' data-title="USD">USD {{$settings->currency}}</option>
                                @endforeach --}}
                                <option value='USD' data-title="USD">USD {{$setting->currency}}</option>
    	...
    	<div class="custom-container">
        	<div class="nav_block">
                ...
                <ul class="navbar-nav attr-nav align-items-center">
                    ...
                    <li><a href="#" class="nav-link"><i class="linearicons-heart"></i><span class="wishlist_count">{{ $wishlist }}</span></a></li>
