    	...
    	<div class="container">
            <nav class="navbar navbar-expand-lg">
                    ...
                    <ul class="navbar-nav">
                        ...
                        @foreach($categories as $category)
                            <li class="dropdown dropdown-mega-menu">
                                <a class="nav-link dropdown-toggle" href="{{ route('slug.handler', $category->category_slug) }}" data-bs-toggle="dropdown">
                ...
                <ul class="navbar-nav attr-nav align-items-center">
                    ...
                    @endphp
                    <li><a href="{{ route('compare.page') }}" class="nav-link"><i class="ti-control-shuffle"></i></a></li>
